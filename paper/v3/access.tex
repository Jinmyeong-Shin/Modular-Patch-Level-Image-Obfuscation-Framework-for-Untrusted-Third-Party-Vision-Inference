...
\midrule
MI-FGSM (100 iter) & 0.031 & 7.12 \\
L-BFGS (500 iter, 3 restarts) & 0.028 & 6.89 \\
Adversarial VAE (50 epochs) & 0.042 & 7.45 \\
\midrule
\textbf{Side-Channel Metric} & \multicolumn{2}{c}{\textbf{Value}} \\
\midrule
Frequency Correlation & \multicolumn{2}{c}{$<$ 0.05} \\
Spatial Autocorrelation & \multicolumn{2}{c}{$<$ 0.03} \\
Histogram KL Divergence & \multicolumn{2}{c}{$>$ 2.5} \\
Mutual Information (bits) & \multicolumn{2}{c}{$<$ 0.02} \\
\bottomrule
\end{tabular}
\end{table}
